            ...
            <div className="hero-content flex-col lg:flex-row">
               ...
               <img src={img2} className="w-3/4 rounded-lg shadow-2xl" />
                ...
                <div className='lg:w-1/2 space-y-5 p-4'>
                    ...
                    <p className="py-6">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which d not look even slightly believable. </p>
